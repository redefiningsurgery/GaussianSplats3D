...
import {
    SplatTree
} from './splattree/SplatTree.js';
import {
    WebGLExtensions
} from './three-shim/WebGLExtensions.js';
import {
    WebGLCapabilities
} from './three-shim/WebGLCapabilities.js';
import {
    uintEncodedFloat,
    rgbaArrayToInteger
} from './Util.js';
...
export class SplatMesh extends THREE.Mesh {
    ...
    refreshGPUDataFromSplatBuffers(sinceLastBuildOnly) {
        ...
        const {
            centers,
            sceneIndexes
        } = this.getDataForDistancesComputation(updateStart, splatCount - 1);
        if (this.enableDistancesComputationOnGPU) {
